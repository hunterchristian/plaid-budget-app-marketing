...
const Hamburger = () => (
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="0 0 501.639 501.639"
    style={{
      enableBackground: 'new 0 0 501.639 501.639',
      width: '50px',
      paddingRight: '8%',
    }}
  >
    <g>
      <g>
        <path
          d="M293.417,0.153h-85.333c-113.067,0-204.8,91.733-205.867,204.8v5.333c0,11.733,9.6,21.333,21.333,21.333h454.4
    ...
    <g>
      <g>
        <path
          d="M493.95,373.486c-4.267-5.333-10.667-8.533-17.067-8.533H23.55c-6.4,0-12.8,3.2-17.067,8.533
    ...
    <g>
      <g>
        <path
          d="M492.883,305.22l-40.533-28.8c-27.733-20.267-66.133-20.267-93.867,0l-4.267,3.2c-13.867,9.6-33.067,9.6-45.867,0
